...
while ($cur_post = $db->fetch_assoc($result))
{
	...
	if ($pun_user['g_view_users'] == '1' && $cur_post['g_id'] != PUN_GUEST)
		$username = '<a href="profile.php?id='.$cur_post['poster_id'].'">'.colorize_group(pun_htmlspecialchars($cur_post['username']), $cur_post['g_id']).'</a>';
	else
		$username = colorize_group2(pun_htmlspecialchars($cur_post['username']), $cur_post['g_id']);
			...
			<div class="box">
				<div class="inbox">
					<div class="postbody">
						<div class="postleft">
							<dl>
								<dd><strong><?php echo $username ?></strong></dd>
